...
## 7. IBM Cloud Code Engine (The Resource Powerhouse)
IBM's unified serverless platform for containers and jobs.
*   **Best for:** Compute-intensive GAS tasks that benefit from IBM's generous free tier and resource isolation.
*   **Pros:** Extremely high memory/CPU limits; **24-hour runtime**; generous perpetual free tier.
*   **Cons:** Requires an IBM API Key to bridge identity to Google WIF (included in this project).
...
| **IBM Code Engine** | **24 hours** | Medium | Yes | WIF + Bridge |
...
- **A task takes 10 hours?** Use **Azure Container Apps**, **IBM Code Engine**, or **GKE**.
